...
| # | Task | Status | Description |
|---|------|--------|-------------|
| 1.5.1 | Install next-intl | [ ] | Add i18n library for Next.js App Router |
| 1.5.2 | Configure i18n routing | [ ] | Setup `/en` and `/he` locale prefixes |
| 1.5.3 | Create translation files | [ ] | `messages/en.json` and `messages/he.json` |
| 1.5.4 | Setup RTL support | [ ] | Dynamic `dir="rtl"` for Hebrew, Tailwind RTL utilities |
| 1.5.5 | Create language switcher | [ ] | UI component to toggle between EN/HE |
| 1.5.6 | Translate existing UI | [ ] | Landing, Dashboard, Levels pages |
| 1.5.7 | Update layout for RTL | [ ] | Ensure header, navigation work in both directions |
