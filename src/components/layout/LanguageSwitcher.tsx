...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-muted transition-colors hover:bg-surface-raised hover:text-foreground"
      aria-label={t('switch')}
    >
      <svg
        className="h-4 w-4"
