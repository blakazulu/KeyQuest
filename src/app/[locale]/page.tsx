    ...
    <div className="flex flex-col items-center justify-center py-16">
      ...
      <div className="mt-20 grid gap-8 sm:grid-cols-3">
        <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-zinc-900">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">{t('features.learnStepByStep.title')}</h3>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-zinc-900">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">{t('features.trackSpeed.title')}</h3>
          <p className="mt-2 text-zinc-600 dark:text-zinc-400">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm dark:bg-zinc-900">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">{t('features.shortSessions.title')}</h3>
          <p className="mt-2 text-zinc-600 dark:text-zinc-400">
